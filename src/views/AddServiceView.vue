<template>
  <div class="container text-center">
    ...
    <div class="card mb-4 shadow-sm">
      <div class="card-body">
        <h5 class="card-title">{{ isEditing ? 'Edit Service' : 'Add Service' }}</h5>

        <div v-if="loading" class="text-center py-4">
          <div class="spinner-border" role="status">
            <span class="visually-hidden">{{ isEditing ? 'Loading...' : 'Submitting...' }}</span>
          </div>
          <p class="mt-2">{{ isEditing ? 'Loading service data...' : 'Creating your service...' }}</p>
        </div>
  ...
  methods: {
    ...
    async loadService() {
      ...
      try {
        ...
        // Map the response data to service object
